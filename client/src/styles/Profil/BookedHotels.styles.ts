...
export const SpanHotelDate = tw.span`border-b-[2px] text-[14px] md:text-[16px] border-mainColor`;

export const SpanHotelName = tw.span`font-bold`;

export const ContainerBookedHotels = tw.div`p-4 bg-white`;
